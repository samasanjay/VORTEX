...
export const ContactPage: React.FC = () => {
  ...
  const budgetOptionsMap: Record<string, string[]> = {
    'E-Commerce Experience': [
      '₹15,000 – ₹30,000 / $180 – $360 (Starter Online Store)',
      '₹30,000 – ₹60,000 / $360 – $720 (Full E-Com + Payment Gateway)',
      '₹60,000 – ₹1,20,000 / $720 – $1,450 (Custom Multi-Vendor / Headless)',
      '₹1,20,000+ / $1,450+ (Enterprise Marketplace)',
      'Flexible / Open for Discussion',
    ],
    'Web Application / SaaS': [
      '₹25,000 – ₹50,000 / $300 – $600 (MVP Web App / Prototype)',
      '₹50,000 – ₹1,00,000 / $600 – $1,200 (Full-Stack SaaS Application)',
      '₹1,00,000 – ₹2,00,000 / $1,200 – $2,400 (Multi-Tenant SaaS with Auth & Billing)',
      '₹2,00,000+ / $2,400+ (Enterprise Cloud Platform)',
      'Flexible / Open for Discussion',
    ],
    'Mobile App (iOS / Android)': [
      '₹30,000 – ₹60,000 / $360 – $720 (Cross-Platform Mobile MVP)',
      '₹60,000 – ₹1,20,000 / $720 – $1,450 (Feature-Rich iOS & Android App)',
      '₹1,20,000 – ₹2,50,000+ / $1,450 – $3,000+ (Complex Mobile App + Cloud Backend)',
      'Flexible / Open for Discussion',
    ],
    'UI/UX & Design System': [
      '₹10,000 – ₹25,000 / $120 – $300 (Wireframes & UI Prototype)',
      '₹25,000 – ₹50,000 / $300 – $600 (Complete Product UI/UX Suite)',
      '₹50,000 – ₹1,00,000+ / $600 – $1,200+ (Comprehensive Design System & Guidelines)',
      'Flexible / Open for Discussion',
    ],
    'Dashboard & Analytics': [
      '₹15,000 – ₹35,000 / $180 – $420 (Interactive Dashboard & Charts)',
      '₹35,000 – ₹75,000 / $420 – $900 (Admin Portal & Role-Based Access)',
      '₹75,000 – ₹1,50,000+ / $900 – $1,800+ (Real-Time Enterprise Analytics Platform)',
      'Flexible / Open for Discussion',
    ],
    'AI & Spatial Interface': [
      '₹20,000 – ₹45,000 / $240 – $540 (AI Agent / Chatbot UI Integration)',
      '₹45,000 – ₹1,00,000 / $540 – $1,200 (Interactive 3D / WebGL Web Experience)',
      '₹1,00,000 – ₹2,00,000+ / $1,200 – $2,400+ (Custom AI Model & 3D Environment)',
      'Flexible / Open for Discussion',
    ],
    'Landing Page / Single Page': [
      '₹5,000 – ₹12,000 / $60 – $145 (High-Impact Modern Landing Page)',
      '₹12,000 – ₹25,000 / $145 – $300 (Interactive 3D Promo / Product Launch)',
      '₹25,000+ / $300+ (Full Marketing Funnel & Lead Engine)',
      'Flexible / Open for Discussion',
    ],
  };
  ...
  const [formData, setFormData] = useState<ContactFormData>({
    ...
    budgetRange: '₹15,000 – ₹30,000 / $180 – $360 (Starter Online Store)',
    timeline: '1–3 months',
    message: '',
  });
