...
import { buildBreadcrumbSchema, buildTechArticleSchema, SITE_URL } from '../config/seo';
import {
  Palette,
  Type,
  LayoutGrid,
...
export const DesignSystemPage: React.FC = () => {
  ...
  const articleSchema = buildTechArticleSchema(
    'WORKVORTEX Design System & Interface Architecture Foundations',
    ...
    `${SITE_URL}/design-system`
  );

  return (
    <div className="pt-32 pb-24 bg-[#F8FAFC]">
      <SEO
        title="Design System & Interface Architecture Foundations — WORKVORTEX"
        description="Explore the WORKVORTEX design system specification: atomic color tokens, mathematical typography scales, fluid responsive grids, and interactive UI components."
      ...
      <div className="container-vortex space-y-12">
        ...
        {/* Tab Selector */}
        <nav aria-label="Design System Sections" className="flex p-1.5 rounded-2xl bg-white border border-slate-200 shadow-sm max-w-fit">
          <button
            onClick={() => setActiveTab('colors')}
            className={`px-5 py-2 rounded-xl font-mono text-xs font-semibold flex items-center gap-2 transition-colors cursor-pointer ${
              activeTab === 'colors'
        ...
        {activeTab === 'colors' && (
          <section aria-label="Color Palette Tokens" className="space-y-6">
            <h2 className="font-display font-bold text-2xl text-slate-900">Color Palette Tokens</h2>
                ...
                >
                  ...
                  >
                    <button
                      ...
                      className="p-2 rounded-lg bg-white/90 shadow-md text-slate-800 hover:bg-white transition-colors cursor-pointer"
        ...
        {/* 2. Typography Scale */}
        {activeTab === 'typography' && (
          <section aria-label="Typography Scale Tokens" className="space-y-6">
            <h2 className="font-display font-bold text-2xl text-slate-900">Typography Scale Hierarchy</h2>
        ...
        {activeTab === 'components' && (
          <section aria-label="Interactive UI Components" className="space-y-6">
            <h2 className="font-display font-bold text-2xl text-slate-900">Live Component Primitives</h2>
                ...
                <div className="space-y-5">
                  <div className="flex items-center justify-between p-3 rounded-xl bg-slate-50 border border-slate-200">
                    ...
                    <button
                      ...
                      aria-label="Toggle GPU acceleration mode"
                  ...
                  <div className="space-y-2 p-3 rounded-xl bg-slate-50 border border-slate-200">
                    ...
                    <input
                      ...
                      aria-label="Mesh density percentage"
