...
export const DesignSystem: React.FC = () => {
  ...
  return (
    <section id="system" className="py-24 bg-[#F8FAFC] border-t border-slate-200/80 relative">
      <div className="container-vortex">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 pb-6 border-b border-slate-200">
          <div>
            <div className="text-xs font-mono text-blue-700 tracking-widest uppercase mb-2 flex items-center gap-2 font-semibold">
